...
################################################################
# This is a generated script based on design: design_iot
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set MY_IN0_0 [ create_bd_port -dir I -from 3 -to 0 MY_IN0_0 ]
  set MY_IN1_0 [ create_bd_port -dir I -from 3 -to 0 MY_IN1_0 ]
  set MY_OUT_0 [ create_bd_port -dir O -from 3 -to 0 MY_OUT_0 ]
  set PWM_OUT_0 [ create_bd_port -dir O -from 5 -to 0 PWM_OUT_0 ]

  # Create instance: myip_0, and set properties
  set myip_0 [ create_bd_cell -type ip -vlnv mycompany:tak:myip:1.0 myip_0 ]

  # Create instance: mypwm_0, and set properties
  set mypwm_0 [ create_bd_cell -type ip -vlnv mycompany:tak:mypwm:1.0 mypwm_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins myip_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net MY_IN0_0_1 [get_bd_ports MY_IN0_0] [get_bd_pins myip_0/MY_IN0]
  connect_bd_net -net MY_IN1_0_1 [get_bd_ports MY_IN1_0] [get_bd_pins myip_0/MY_IN1]
  connect_bd_net -net myip_0_MY_OUT [get_bd_ports MY_OUT_0] [get_bd_pins myip_0/MY_OUT]
  connect_bd_net -net mypwm_0_PWM_OUT [get_bd_ports PWM_OUT_0] [get_bd_pins mypwm_0/PWM_OUT]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins myip_0/s00_axi_aclk] [get_bd_pins mypwm_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins myip_0/s00_axi_aresetn] [get_bd_pins mypwm_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myip_0/S00_AXI/S00_AXI_reg] SEG_myip_0_S00_AXI_reg
